...
import { hasWon, isPieceAllowed } from './gameLogic';
...
const Quantik: React.FC = () =>{
    ...
    return (
        <div className="Game">
            <div>
              <div>
                  {/* <span className='turn'>le tour du joueur {currentPlayer.color}</span> */}
              </div>
              <div className='Board'>
            ...
            <div className="Controls">
              ...
              <div className="Choice" id='choice'>
                {select &&
                  ...
                  <div>
                      <p className='pieceType'>Choisissez votre piece :</p>
